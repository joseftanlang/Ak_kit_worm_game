...
enum {
	...
	//hold
	AC_DISPLAY_BUTON_UP_HOLD,
	AC_DISPLAY_BUTON_DOWN_HOLD,
	AC_DISPLAY_BUTON_MODE_HOLD,

	//double button pressed
	AC_DISPLAY_BUTON_UP_DOWN_PRESSED,
	AC_DISPLAY_BUTON_UP_MODE_PRESSED,
	AC_DISPLAY_BUTON_DOWN_MODE_PRESSED,
