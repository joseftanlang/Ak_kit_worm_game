...
static void qrcode_build_bitmap()
{
	...
	qrcode_initText(&qrcode, qrcodeData, QRCODE_VERSION, 0, "https://github.com/joseftanlang/akkit-worm.io");
...
void scr_qrcode_handle(ak_msg_t *msg)
{
	...
	{
		APP_DBG_SIG("AC_DISPLAY_BUTON_%s_PRESSED\n", msg->sig == AC_DISPLAY_BUTON_MODE_PRESSED ? "MODE" : msg->sig == AC_DISPLAY_BUTON_DOWN_PRESSED ? "DOWN"
																																					: "UP");
